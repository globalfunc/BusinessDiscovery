...
Fable 5 carries the onboarding interview + AI discovery suggestion sessions (S3.1–S3.3) plus four flagged high-complexity sessions (vendor-safety filtering S3.4, generative spec/proposal assembly S3.5/S4.5, email generation S4.6). Everything else — scaffolding, CRUD, admin UI, infra, tests — runs on the current model at medium effort.
